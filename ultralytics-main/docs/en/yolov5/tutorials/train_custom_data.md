...
```bash
../datasets/k/images/im0.jpg # Path to the image file
../datasets/k/labels/im0.txt # Path to the corresponding label file
```
...
python train.py --img 640 --batch 16 --epochs 3 --data k.yaml --weights yolov5s.pt
```
...
python train.py --img 640 --epochs 3 --data k.yaml --weights yolov5s.pt # 3. Train your model - Comet automatically logs everything!
```
